...
class DictionariesControllerTest < ActionController::TestCase
  ...
  test "should create dictionary" do
    assert_difference('Dictionary.count') do
      post :create, dictionary: { definition: @dictionary.definition, term: @dictionary.term, tittle: @dictionary.tittle }
    end
  ...
  test "should update dictionary" do
    patch :update, id: @dictionary, dictionary: { definition: @dictionary.definition, term: @dictionary.term, tittle: @dictionary.tittle }
    assert_redirected_to dictionary_path(assigns(:dictionary))
  end
